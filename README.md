...
- On macOS, see each Codex account's available banked usage-reset count without redeeming a reset
...
- **Banked Reset Visibility on macOS** — Show each Codex account's available reset count without redeeming it
